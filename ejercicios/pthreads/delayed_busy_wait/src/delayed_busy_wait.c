 ...
 * utiliza espera activa como mecanismo de sincronización (control de 
 * concurrencia).
 */
...
typedef struct shared_data {
  /**
   * @brief Se usa para controlar el orden en que los hilos imprimen su saludo.
   */
...
void* greet(void* data) {
  ...
  /**
   * @brief Lleva a cabo la espera activa, consumiendo recursos del CPU.
   */
